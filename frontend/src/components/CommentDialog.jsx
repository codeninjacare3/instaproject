            ...
            <DialogContent onInteractOutside={() => setOpen(false)} className='max-w-5xl p-0 flex flex-col'>
                ...
                <div className='flex flex-1'>
                    ...
                    <div className='w-1/2 flex flex-col justify-between'>
                        ...
                        <hr />
                        <div className='flex-1 overflowy-auto max-h-97 p-4'>
                            {
                        ...
                        <div className='p-4'>
                            <div className='flex items-center gap-2'>
                                <Input type="text" value={text} onChange={changeEventHandler} placeholder='Add a comment...' className='text-sm w-full outline-none border-gray-300 p-2 rounded' />
