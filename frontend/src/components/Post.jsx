        ...
        <div className='my-8 w-full max-w-sm mx-auto'>
            <div className='flex items-center justify-between'>
                ...
                <Dialog>
                    ...
                    <DialogContent className='flex flex-col items-center text-sm text-center p-0 py-3 gap-2'>
                        {
                            post?.author?._id !== user?._id && <Button variant='ghost' className='cursor-pointer w-full text-[#ed4956] hover:text-[#ed4956] font-bold bg-transparent border-b border-b-gray-300 rounded-none focus-visible:ring-transparent hover:border-none hover:bg-transparent'>Unfollow</Button>
                        }
                        
                        <Button variant='ghost' className='cursor-pointer w-full bg-transparent hover:border-none hover:bg-transparent focus:outline-none focus:ring-0 focus:ring-transparent'>Add to favorites</Button>
                        {
                            user && user?._id === post?.author._id && <Button onClick={deletePostHandler} variant='ghost' className='cursor-pointer w-full bg-transparent border-none hover:border-none hover:bg-transparent focus:outline-none focus:ring-0'>Delete</Button>
                        }
